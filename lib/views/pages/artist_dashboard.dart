              ...
              child: Column(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [AppColors.accent, Color(0xFF3677FF)],
                      ),
                    ...
                    builder: (context, authProvider, _) {
                      ...
                      return Column(
                        children: [
                          ...
                          Text(
                            user?.email ?? 'artist@soundguide.com',
                            style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      _buildProfileStat(label: 'Followers', value: '1.2K'),
                      const SizedBox(width: 24),
                      _buildProfileStat(label: 'Gigs', value: '24'),
                      const SizedBox(width: 24),
                      _buildProfileStat(label: 'Rating', value: '4.9★'),
                    ],
                  ),
                ],
              ),
